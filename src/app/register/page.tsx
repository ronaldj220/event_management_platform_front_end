                    ...
                    <div className="mx-auto max-w-xs">
                        ...
                        <div className="flex mt-5 justify-center">
                            ...
                            <div className="flex items-center me-4">
                                ...
                                <label htmlFor="" className='ms-2 text-sm font-medium text-gray-900 dark:text-gray-900'>Organizer</label>
                            </div>
                        </div>
                        <div className='mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none'>Sign Up</div>
                    </div>
                </div>
            </div>
        </div>
